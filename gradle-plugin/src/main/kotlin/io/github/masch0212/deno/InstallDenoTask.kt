...
open class InstallDenoTask @Inject constructor(private val execOperations: ExecOperations) :
  DefaultTask() {
  @Input @Optional var version: String = "latest"
  ...
  private fun extractZip(zipFile: File, outputDir: File, unzipTool: String) {
